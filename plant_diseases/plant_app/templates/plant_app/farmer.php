...
if(isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO `farmers`(`name`, `phone`, `crop`, `quantity`, `amount`) VALUES ('$name','$phone','$crop','$qun','$amt')";
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="container">
            ...
            <input type="text" class="form-control" placeholder="Enter Quantity in KG" name="qun" required>
