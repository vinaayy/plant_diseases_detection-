...
if(isset($_POST['submit']))
{
    ...
    {
        $query = "INSERT INTO `farmer`(`name`, `password`, `phone`,`type`) VALUES ('$name','$password','$phone','$type')";
  ...
  <body>
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="container">
            ...
            <div>
              <input type="radio" name="type" value="farmer"><span>Farmer</span>
              <input type="radio" name="type" value="vendor"><span>Vendor</span>
            </div>
